...
const AllMovies = () => {
  ...
  const movies = [
    ...
    },
    {
        ...
        platform: 'Netflix, Amazon',
        type: 'Pelicula',
        trailer: '<iframe width="560" height="315" src="https://www.youtube.com/embed/C0BMx-qxsP4?start=7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
    },
    {
        id: 10,
